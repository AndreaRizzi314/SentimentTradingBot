...
#Shuffle randomly all the items in the Candidate Ticker List 
...
for i in range(0, Positions_Left_To_Buy):
    ...
    while True:
        ...
        Symbol_To_Evaluate_Buying = Candidate_Tickers[Stock_List_Position]
...
Diversification = Configration_Object["Diversification"]
Number_of_Stocks = len(Candidate_Tickers)
